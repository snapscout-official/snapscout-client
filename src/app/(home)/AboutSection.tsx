    ...
    return (
        <div id="about" className="bg-[#DAE6F8] relative">
            ...
            <div className="w-[70%] mx-auto grid lg:grid-cols-3 lg:gap-x-7">
                <div className=" flex flex-col space-y-6 lg:col-span-2 xl:space-y-10 justify-center">
                ...
                <div className="col-span flex justify-center lg:justify-end">
